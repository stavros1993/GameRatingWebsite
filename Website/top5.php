...
else
{
	...
	$result = mysql_query("SELECT name,sum_all/(users_voted*3),users_voted FROM candidate ORDER BY sum_all DESC LIMIT 5");
	$row = mysql_fetch_array($result);
	
	echo '<p><font size="5">';
	echo '<b>  TOP 5 current videogames:';
	echo '</p></font>';
	...
	echo '<tr align="left" >';
	echo '<td align="left">';
	echo'<a href="top5_all.php"><button>Show more</button></a>';
	echo '</td>';
	echo '</tr>';	
	echo '</table>';
